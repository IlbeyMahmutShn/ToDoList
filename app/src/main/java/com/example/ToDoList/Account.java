...
public class Account extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Firebase'den kullanıcı verilerini al ve TextView'ları güncelle
        ...
        if (currentUser != null) {
            ...
            userRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(DatabaseError databaseError) {
                    // Veritabanı hatasını yönet
                }
            });
        }

        // Şifre değişikliği için layout ve bileşenleri bul
    ...
    public void onClick(View v) {
        // Şifre değiştirme diyalog penceresini göster
        ChangePassword dialogFragment = new ChangePassword();
