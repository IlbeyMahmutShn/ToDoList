...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    private void showDeleteConfirmationDialog(final Task task) {
        ...
        builder.setMessage("Bu görevi silmek istediğinizden emin misiniz?");
    ...
    public static class TaskViewHolder extends RecyclerView.ViewHolder {
        ...
        private String getMonthString(int month) {
            String[] monthArray = {"Ocak", "Şubat", "Mart", "Nisan", "Mayıs", "Haziran", "Temmuz", "Ağustos", "Eylül", "Ekim", "Kasım", "Aralık"};
            if (month >= 1 && month <= 12) {
